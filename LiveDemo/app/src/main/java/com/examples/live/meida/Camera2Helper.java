...
import com.examples.live.utils.ImageUtil;

import java.nio.ByteBuffer;
import java.util.Arrays;
import java.util.Objects;

import static com.examples.live.utils.ImageUtil.YUV420P;
...
public class Camera2Helper implements SurfaceHolder.Callback, ImageReader.OnImageAvailableListener {
    ...
    public void onImageAvailable(ImageReader reader) {
        ...
        System.arraycopy(Objects.requireNonNull(ImageUtil.getBytesFromImageAsType(image, YUV420P)), 0, yuv420pbuf, 0, n_image_size);
