...
public class RotateGestureDetector implements IRotateDetector{
    ...
    //    Log.v("dyp","ev.getX(0):"+ev.getX(0)+",ev.getY(0):"+ev.getY(0)+",ev.getX(1):"+ev.getX(1)+",ev.getY(1):"+ev.getY(1));
    //    Log.v("dyp","degress:"+degrees+",deltay:"+deltaY+",deltaX:"+deltaX+",deltaY/deltaX:"+(deltaY/deltaX));
        int degrees = (int) Math.round(Math.toDegrees(Math.atan2(deltaY,deltaX)));
        Log.v("dyp6","degrees:"+degrees);
        /*
        ...
        switch (ev.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.v("dyp1","degressValue:"+degreesValue);
                if (degreesValue > 45) {
