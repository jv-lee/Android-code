...
import code.lee.code.vlayout.adapter.BaseDelegeteAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        //设置回收池 设置10种不同的布局进行回收
        recycledViewPool.setMaxRecycledViews(0,10);
        BaseDelegeteAdapter bannerAdapter = new BaseDelegeteAdapter(this, new LinearLayoutHelper(),
                R.layout.vlayout_banner, 1){
            @Override
        ...
        BaseDelegeteAdapter menuAdapter = new BaseDelegeteAdapter(this,gridLayoutHelper , R.layout.vlayout_menu, 10){
            ...
            public void onBindViewHolder(@NonNull BaseViewHolder baseViewHolder, final int i) {
                baseViewHolder.setText(R.id.tv_menu_title_home, ITEM_NAMES[i] + "");
                baseViewHolder.setImageResource(R.id.iv_menu_home, IMG_URLS[i]);
                baseViewHolder.getView(R.id.ll_menu_home).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(MainActivity.this, ITEM_NAMES[i], Toast.LENGTH_SHORT).show();
                    }
                });
            }
        };
        ...
        for (int i = 0; i < ITEM_URL.length; i++) {
            ...
            BaseDelegeteAdapter titleAdapter = new BaseDelegeteAdapter(this, new LinearLayoutHelper(), R.layout.vlayout_title, 1) {
                ...
                public void onBindViewHolder(@NonNull BaseViewHolder baseViewHolder, int i) {
                    super.onBindViewHolder(baseViewHolder, i);
                    baseViewHolder.setImageResource(R.id.iv, ITEM_URL[I]);
                }
            };
            BaseDelegeteAdapter gridAdapter = new BaseDelegeteAdapter(this, new GridLayoutHelper(2), R.layout.vlayout_grid, 4) {
                @Override
                public void onBindViewHolder(@NonNull BaseViewHolder baseViewHolder, int i) {
                    int item = GRID_URL[i];
