...
import com.lee.library.widget.banner.transformer.CustomTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private void init() {
        View view = null;
        if (mIsOpenMZEffect) {
            view = LayoutInflater.from(getContext()).inflate(R.layout.widget_banner_effect_layout, this, true);
        } else {
            view = LayoutInflater.from(getContext()).inflate(R.layout.widget_banner_normal_layout, this, true);
        }
    ...
    public static class MZPagerAdapter<T> extends PagerAdapter {
        ...
        @Override
        public int getCount() {
            // 如果getCount 的返回值为Integer.MAX_VALUE 的话，那么在setCurrentItem的时候会ANR(除了在onCreate 调用之外) //ViewPager返回int 最大值
