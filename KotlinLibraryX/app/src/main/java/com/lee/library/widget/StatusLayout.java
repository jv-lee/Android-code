...
public class StatusLayout extends FrameLayout {
    ...
    private void readAttrs(Context context, AttributeSet attrs) {
        ...
        loadingId = typedArray.getResourceId(R.styleable.StatusLayout_layout_loading, R.layout.widget_status_loading);
        errorId = typedArray.getResourceId(R.styleable.StatusLayout_layout_error, R.layout.widget_status_error);
        networkId = typedArray.getResourceId(R.styleable.StatusLayout_layout_network, R.layout.widget_status_not_network);
        emptyId = typedArray.getResourceId(R.styleable.StatusLayout_layout_empty, R.layout.widget_status_empty);
        typedArray.recycle();
    }
