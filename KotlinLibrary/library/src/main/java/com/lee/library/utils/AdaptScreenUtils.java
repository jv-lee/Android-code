...
public final class AdaptScreenUtils {
    ...
    public static int pt2Px(final float ptValue) {
        DisplayMetrics metrics = BaseApplication.Companion.getContext().getResources().getDisplayMetrics();
    ...
    private static void applyDisplayMetrics(final Resources resources, final float newXdpi) {
        ...
        BaseApplication.Companion.getContext().getResources().getDisplayMetrics().xdpi = newXdpi;
