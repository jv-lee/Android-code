...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.vp_container, 2);
        sViewsWithIds.put(R.id.nav, 3);
        sViewsWithIds.put(R.id.iv_active, 4);
        sViewsWithIds.put(R.id.frame_usercenter_container, 5);
    }
    // views
    @NonNull
    ...
    private ActivityMainBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (gionee.gnservice.app.view.widget.TouchMoveView) bindings[4]
            , (com.lee.library.widget.nav.BottomNavView) bindings[3]
            , (android.view.View) bindings[1]
            , (com.lee.library.widget.NoScrollViewPager) bindings[2]
            );
