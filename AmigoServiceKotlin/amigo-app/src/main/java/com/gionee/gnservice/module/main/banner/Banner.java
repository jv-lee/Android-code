...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.uc_banner_select_radius;
    private int mIndicatorUnselectedResId = R.drawable.uc_banner_unselect_radius;
    private int mLayoutResId = R.layout.uc_view_banner;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        viewPager.setPageMargin(getResources().getDimensionPixelSize(R.dimen.uc_banner_viewpager_margin));
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.uc_banner_select_radius);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.uc_banner_unselect_radius);
