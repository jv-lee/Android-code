 ...
 */
public class TiroTaskFragment extends Fragment implements IMemberIntegralMakeContract.View {
    private static final String TAG = TiroTaskFragment.class.getSimpleName();
    private ListView mListMenu;
    private List<IntegralTask> mIntegralTasks;
    private ItemAdapter mAdapter;
    private View mLoadingView;
    private View mEmptyView;
    private View mLayoutScroll;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        mLayoutScroll = getView(rootView, getWidgetId(getActivity(), "layout_member_integral_task_prize"));
        return rootView;
    }
        ...
        switch (task.getType()) {
            ...
            case IntegralTask.TYPE_APP:
                ...
                if (isJson(content)) {
                    ...
                    LogUtil.d(TAG, "item click,content is:" + content + "packagename is:" + packageName + ";action is:" + action);
                ...
                if (intent.resolveActivity(getContext().getPackageManager()) != null) {
                    startActivity(intent);
                    StatisticsUtil.onEvent(getContext(), task.getId() + "-" + task.getName(), StatisticsEvents.Label.TIRO_MISSION);
                } else {
    ...
    private List<IntegralTask> filterData(List<IntegralTask> integralTasks) {
        ...
        for (IntegralTask task : integralTasks) {
            if (task.getIntegralType() == IntegralTask.PTYPE_TIRO) {
                tasks.add(task);
            }
        }
        return tasks;
