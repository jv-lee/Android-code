...
import com.gionee.gnservice.sdk.integral.LoadFreshHeaderView;
import com.gionee.gnservice.sdk.integral.LoadMoreFootView;
import com.gionee.gnservice.widget.fresh.processor.AnimProcessor;
import com.gionee.gnservice.widget.fresh.processor.IDecorator;
import com.gionee.gnservice.widget.fresh.processor.OverScrollDecorator;
import com.gionee.gnservice.widget.fresh.processor.RefreshProcessor;
...
public class TwinklingRefreshLayout extends RelativeLayout implements PullListener {
    ...
    public TwinklingRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHeadHeight = DensityUtil.dp2px(context, 80);
