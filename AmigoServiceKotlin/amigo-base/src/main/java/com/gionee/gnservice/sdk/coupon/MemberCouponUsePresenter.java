 ...
 */
class MemberCouponUsePresenter implements IMemberCouponContract.Presenter {
    ...
    MemberCouponUsePresenter(IAppContext appContext, IMemberCouponContract.View view) {
    ...
    private void load(int pageNumber, int pageSize) {
        ...
        mCouponCase.getCouponsUseable(pageNumber, pageSize, new Observer<List<CouponInfo>>() {
            @Override
