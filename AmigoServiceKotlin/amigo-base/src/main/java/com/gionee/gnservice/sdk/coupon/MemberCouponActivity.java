 ...
 */
public class MemberCouponActivity extends BaseSdkActivity implements IMemberCouponContract.View {
    private static final String TAG = MemberCouponActivity.class.getSimpleName();
    private TwinklingRefreshLayout mRefreshLayout;
    private ListView mRecyclerView;
    private ItemAdapter mAdapter;
    private MemberCouponUsePresenter mPresenter;
    ...
    protected void initVariables() {
        ...
        mPresenter = new MemberCouponUsePresenter(appContext(), this);
    }
    ...
    protected String getActionbarTitle() {
        return getString(ResourceUtil.getStringId(this, "uc_title_member_coupon_actionbar"));
    }

    @Override
    protected String getActionbarRightTitle() {
        return getString(ResourceUtil.getStringId(this, "uc_txt_member_coupon_expired"));
    }

    @Override
    protected void onActionRightTextClick(View view) {
        super.onActionRightTextClick(view);
        Intent intent = new Intent(this, MemberCouponExpiredActivity.class);
        startActivity(intent);
        StatisticsUtil.onEvent(this, StatisticsEvents.Main.OVERDUE_COUPON);
    }
            ...
            if (convertView == null) {
                ...
                switch (status) {
                    case STATUS_STANDARD:
                        viewHolder.layoutUsed.setVisibility(View.GONE);
                        viewHolder.layoutUnuse.setVisibility(View.VISIBLE);
                        viewHolder.txtNumber = getView(convertView, getWidgetId(mContext, "txt_list_item_member_coupon_number"));
                        viewHolder.txtDescription = getView(convertView, getWidgetId(mContext, "txt_list_item_member_coupon_description"));
                        viewHolder.txtType = getView(convertView, getWidgetId(mContext, "txt_list_item_member_coupon_type"));
                        viewHolder.txtName = getView(convertView, getWidgetId(mContext, "txt_list_item_member_coupon_name"));
                        viewHolder.txtDuration = getView(convertView, getWidgetId(mContext, "txt_list_item_member_coupon_duration"));
                        viewHolder.txtLimit = getView(convertView, getWidgetId(mContext, "txt_list_item_member_coupon_number_limit"));
                        break;
                    case STATUS_USED:
                        ...
                        viewHolder.txtStatus.setText(ResourceUtil.getString(mContext, "uc_txt_member_coupon_used"));
                        break;
                    default:
                        break;
                }
